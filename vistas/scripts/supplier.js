    ...
    function listar() {
        tabla = $("#tbllistado").DataTable({
            "ajax": {
                url: "../controlador/SupplierController.php?op=listar",
                type: "get",
                dataType: "json",
                error: function (e) {
    ...
    function consultarRUCUpdate(ruc) {
        $.ajax({
            url: 'proxyRUC.php', // Cambia la ruta si es necesario
            method: 'GET',
            data: { ruc: ruc },
            success: function (response) {
                try {
    ...
    function guardar(e) {
        ...
        $.ajax({
            url: "../controlador/SupplierController.php?op=guardar",
            type: "POST",
            data: formData,
            contentType: false,
            processData: false,
    ...
    function actualizar(e) {
        ...
        $.ajax({
            url: "../controlador/SupplierController.php?op=editar",
            type: "POST",
            data: formData,
            contentType: false,
            processData: false,
    ...
    function activar(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.post("../controlador/SupplierController.php?op=activar", { id: id }, function (response) {
                    mostrarNotificacion(response, "success");
                    tabla.ajax.reload();
                });
            }
    ...
    function desactivar(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.post("../controlador/SupplierController.php?op=desactivar", { id: id }, function (response) {
                    mostrarNotificacion(response, "success");
                    tabla.ajax.reload();
                });
            }
    ...
    function mostrar(id) {
        $.post("../controlador/SupplierController.php?op=mostrar", { id: id }, function (data) {
