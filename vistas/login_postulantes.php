...
<body>
            ...
            <div class="card-body">
                ...
                <form class="form-horizontal form-material" id="frmAccesoPostulante" method="post">
                    ...
                    <div class="form-group">
                        <div class="col-xs-12">
                            <input class="form-control" id="clavep" name="clavep" type="password" required placeholder="Contraseña" autocomplete="current-password">
                        </div>
                    </div>
    ...
    <script type="text/javascript">
        ...
        // Toggle entre el formulario de login y recuperación de contraseña para postulantes
        $('#to-recover-postulante').on("click", function () {
            $("#frmAccesoPostulante").slideUp();
            $("#recoverform-postulante").slideDown();
        });
    </script>
