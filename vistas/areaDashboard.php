                    ...
                    <div class="tab-content" id="myTabContent">
                        ...
                        <div class="tab-pane fade show active" id="companies" role="tabpanel" aria-labelledby="companies-tab">
                            <div class="mt-4">
                                ...
                                <div class="table-responsive">
                                    <table id="tbllistadoCompanies" class="table table-striped table-bordered" style="width:100%">
                        ...
                        <div class="tab-pane fade" id="areas" role="tabpanel" aria-labelledby="areas-tab">
                            <div class="mt-4">
                                ...
                                <div class="table-responsive">
                                    <table id="tbllistadoAreas" class="table table-striped table-bordered" style="width:100%">
                                        <thead style="background-color: #2A3E52; color: white;">
                                            <tr>
                                                <th width="5%">ID</th>
                                                <th width="25%">Área</th>
                        ...
                        <div class="tab-pane fade" id="jobs" role="tabpanel" aria-labelledby="jobs-tab">
                            <div class="mt-4">
                                ...
                                <div class="table-responsive">
                                    <table id="tbllistadoJobs" class="table table-striped table-bordered" style="width:100%">
                                        <thead style="background-color: #2A3E52; color: white;">
                                            <tr>
                                                <th width="5%">ID</th>
