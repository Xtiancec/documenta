...
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h3 class="text-themecolor">Documentos Pendientes por Aprobar</h3>
    </div>
    <div class="col-md-7 align-self-center">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="index.php">Inicio</a></li>
            <li class="breadcrumb-item">Configuración</li>
            <li class="breadcrumb-item active">Aprobacion/Rechazo de Documentos</li>
        </ol>
    </div>
    <div>
                    ...
                    <table id="tbllistado" class="table table-hover non-hover" style="width:100%">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <th>Maquinista</th>
                                <th>Obligatorio</th>
                                <th>Declaracion Jurada Domicilio</th>
                                <th>Pendiente de Aprobación</th>
                                <th><span class="label label-info">Aprobar</span>
                                <span class="label label-danger">Desaprobar</span></th>
                            </tr>
                            <tr>
                                <th>44444444</th>
                                <th>Juan Perez</th>
