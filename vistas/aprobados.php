...
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h3 class="text-themecolor">Trabajadores Aprobados</h3>
    </div>
    <div class="col-md-7 align-self-center">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="index.php">Inicio</a></li>
            <li class="breadcrumb-item">Configuración</li>
            <li class="breadcrumb-item active">Trabajadores Aprobados</li>
        </ol>
    </div>
    <div>
                    ...
                    <table id="tbllistado" class="table table-hover non-hover" style="width:100%">
                        ...
                        <tbody>
                            <tr>
                                <th>5555555</th>
                                <th>Juan Perez</th>
                                <th>Andina Energy SAC</th>
                                <th>Maquinista</th>
                                <th><span class="label label-info">Aprobado</span></th>
                                <th><span class="label label-primary">Ver Documentos</span></th>
                            </tr>
                            <tr>
                                <th>7777777</th>
                                <th>Benito Came</th>
                                <th>BlacRock Project-Cargo</th>
                                <th>Operaciones</th>
                                <th><span class="label label-info">Aprobado</span></th>
                                <th><span class="label label-primary">Ver Documentos</span></th>
                            </tr>
